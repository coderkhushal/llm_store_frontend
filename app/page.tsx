...
const Shapes = () => (
	<>
		...
		<div className="absolute -top-[15%] -right-[15%] w-[600px] h-[600px] rounded-full  dark:bg-slate-800 -z-20" />
	</>
);
...
const Home = () => {
	...
	return (
		<div className="h-full  bg-gradient-to-r from-green-800 to-slate-900">
			<Navbar />
			<header className="py-14 md:py-24   text-white relative overflow-hidden z-10">
				<Shapes />
					...
					<div className="grid grid-cols-12 gap-6 items-center">
						<div className="col-span-12 lg:col-span-7 xl:col-span-6 text-center lg:text-start mb-12 lg:mb-0">
							...
							<div className="max-w-xl">
								<p className="text-[17px] leading-relaxed opacity-80 my-12">
									LLM Store is a platform where user can deploy their llms within a few clicks and use other publically available LLMs developed by others like you in your projects. LLM store helps in deploying , sharing and using LLMs in a very easy way.
								</p>
							</div>
							<Link href={"/client"}>
						...
						<div className="col-span-12 lg:col-span-5 relative text-center">
							...
							<div className="relative">
								<img
									src="https://cdn.pixabay.com/photo/2023/11/29/22/14/ai-8420370_960_720.jpg"
									alt=""
									className="max-w-full hidden lg:flex h-auto rounded-full mx-auto"
								/>
								<div className="absolute w-[500px] h-[500px] left-0 top-0  dark:bg-slate-800 rounded-full -z-20"></div>
							</div>
						</div>
					</div>
				</div>
