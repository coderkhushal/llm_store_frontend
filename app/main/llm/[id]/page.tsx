        ...
        <div className="w-full flex flex-col justify-center items-center">
            ...
            <div className="flex flex-col w-5/6  py-10">
                <div className="flex w-full  ">
                    ...
                    <Image src={llm.modelImage ? llm.modelImage : "https://cdn.pixabay.com/photo/2023/11/29/22/14/ai-8420370_960_720.jpg"} width={400} height={400} alt={llm.title} className='rounded-3xl ' />
                    <div className="flex pl-32 py-5 w-full  p-5 rounded-3xl space-y-2 flex-col">
                        ...
                        <h1 className='font-semibold text-lg  py-4 h-32 overflow-y-auto '>{llm.content}</h1>
